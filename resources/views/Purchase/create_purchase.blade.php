...
<div class="row page-titles">
    <div class="col-md-12 col-12 align-self-center">
        <h4 class="font-weight-normal">@lang('lang.purchase') @lang('lang.create')</h4>
    </div>
</div>
                        ...
                        @if ($item->counting_units)
                            @foreach ($item->counting_units as $counting_unit)
                                ...
                                <option data-unitname="{{$counting_unit->unit_name}}"
                                    ...
                                    data-wholeprice="{{$counting_unit->whole_sale_price ?? 0}}"

                                    data-normalfixed="{{$counting_unit->normal_fixed_percent}}"
                                    data-wholefixed="{{$counting_unit->whole_fixed_percent ?? 0}}"

                                    data-wholefixedflash="{{$counting_unit->whole_fixed_flash}}"
                                    data-normalfixedflash="{{$counting_unit->normal_fixed_flash ?? 0}}"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">Pharmacy Price</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">Patient Price</label>
                                <div class="col-md-9">
...
<script type="text/javascript">
    ...
    $('#change_price').click(function(e){
        e.preventDefault();
          ...
          console.log(unit_id,purchase_price,normal_price,whole_price);

          if($.trim(unit_id) == '' || $.trim(purchase_price) <= 0 || $.trim(normal_price) <= 0 || $.trim(whole_price) <= 0 )
    {
        swal({
            title:"Failed!",
