            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="{{route('doctor.schedulelist')}}"><span><i class="pinkcolor 	fa fa-adjust"></i>Your Schedules</span></a>
                        </li>
                        <li>
                            <a href="{{route('today.appointments')}}"><span><i class="pinkcolor fa fa-copy"></i>Appointments</span></a>
                        </li>
                        <li>
                            <a href="{{route('history')}}"><span> <i class="pinkcolor fa fa-save"></i>Clinic Patient History</span></a>
                        </li>
                        ...
                        <li>
                            <a href="{{route('clinic_sale_history')}}"><i class="pinkcolor pinkcolor fa fa-save"></i><span> Sale History</span></a>
                        </li>

                        @endif

                        @if(session()->get('user')->role == "Owner" && session()->get('from') == 1)
                        <li>
                            <a href="{{route('index')}}">
                        ...
                        @endif
                        @if((session()->get('user')->role == "Owner" && session()->get('from') == 1 )|| session()->get('user')->role == "Inventory_Stock" || session()->get('user')->role == "Finance")
                        <li>
                        ...
                        @endif
                        @if((session()->get('user')->role == "Owner" && session()->get('from') == 1 ) || session()->get('user')->role == "Inventory_Stock" || session()->get('user')->role == "Stock" || session()->get('user')->role == "Finance")
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                @if((session()->get('user')->role == "Owner" && session()->get('from') == 1 ) || session()->get('user')->role == "Inventory_Stock")
                                ...
                                <li><a href="{{route('create_itemrequest')}}">Request Item</a></li>
                                @endif
                                 @if(session()->get('user')->role == "Inventory_Stock")
                        ...
                        @endif
                        @if((session()->get('user')->role == "Owner" && session()->get('from') == 1 ) || session()->get('user')->role == "Sale")
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                @if((session()->get('user')->role == "Owner" && session()->get('from') == 1 ))
                                <li><a href="{{route('list')}}">Sale Customer Credit Lists</a></li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{route('customer_list')}}">Order @lang('lang.customer') @lang('lang.list')</a></li>
                                <li><a href="{{route('purchase_list')}}">@lang('lang.purchase') @lang('lang.list')</a></li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{route('incomes')}}">Incomes @lang('lang.list')</a></li>
                                <li><a href="{{route('fixasset')}}">@lang('lang.fixasset') </a></li>
                                <li><a href="{{route('show_capital')}}">Capital Panel</a></li>
                                <li><a href="{{route('receivable_payable_lists')}}">Receivable and Payable</a></li>

                            </ul>
                        </li>
                        @endif

                        @if ((session()->get('user')->role == "Owner" && session()->get('from') == 2 ))
                        <li>
                            <a href="{{route('patientregister')}}"><i class="pinkcolor fa fa-plus"></i><span>Patient Register</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{route('history')}}"><i class="pinkcolor pinkcolor fa fa-save"></i><span> Clinic Patient History</span></a>
                        </li>
                        <li>
                            <a href="{{route('clinic_sale_history')}}"><i class="pinkcolor fa fa-copy"></i><span> Sale History</span></a>
                        </li>
                        <li class="dropdown-submenu"><a class="dropdown-item" href="#"> Doctors</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{route('doctor_list')}}">Doctors List</a></li>

                                <li><a href="{{route('schedule_list')}}">Doctor Schedule</a></li>

                                <li><a href="">Change Doctor Schedule</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu"><a class="dropdown-item" href="#"> Admin</a>
                            <ul class="dropdown-menu">
                                <li><a href="{{route('getprocuduregroup')}}">Procedure Group</a></li>

                                <li><a href="{{route('getprocedureitem')}}">Procedure Item</a></li>

                                <li><a href="{{route('getroomusage')}}">OT Room Usage</a></li>
                                ...
                                <li><a href="{{route('department_list')}}">Departments</a></li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('logoutprocess')}}"><i class="mdi mdi-power" style="font-size: 20px"></i> <span>@lang('lang.logout')</span></a>
                        </li>
                        @php
